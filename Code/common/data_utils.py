...
sg_cubic = [i for i in range(195, 231)]

sg_general = [i for i in range(0, 231)]
...
carbon_symbols = ['C']
metal_cluster = ['N','S', 'P', 'O','Sc', 'Ti', 'V', 'Cr', 'Mn', 'Fe', 'Co', 'Ni', 'Cu', 'Zn','Y', 'Zr', 'Nb', 'Mo', 'Tc', 'Ru', 'Rh', 'Pd', 'Ag', 'Cd']
battery_symbols = ['S', 'B', 'C', 'N', 'O', 'P', 'Cl', 'Br', 'I', 'Si', 'Be', 'Na', 'Li', 'K']
battery_symbols_Al = ['S', 'B', 'C', 'N', 'O', 'P', 'Cl', 'Br', 'I', 'Si', 'Be', 'Na', 'Li', 'K', 'Al']
